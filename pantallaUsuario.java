...
public class pantallaUsuario extends JFrame {
    ...
    public pantallaUsuario(String nombreUsuario, Connection conexion) {
        ...
        try {
            ...
            if (resultSet.next()) {
                for (int i = 0; i < 5; i++) {
                    campos[i] = new JTextField(resultSet.getString(i + 1));
    ...
    public static void main(String[] args) {
        // Puedes probar la pantallaUsuario aquí si es necesario
        // Solo para propósitos de prueba, deberías iniciar la aplicación de una manera más adecuada en un entorno real.
        SwingUtilities.invokeLater(() -> {
            pantallaUsuario pantallaUsuario = new pantallaUsuario("NombreDeUsuario", null);
