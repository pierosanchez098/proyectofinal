     ...
     // Obtener datos de la tabla "estancia"
        try {
            ...
            while (resultSet.next()) {
                ...
                infoPanel.add(CrearLabel("Precio por D�a: " + precioDia + "�"));
                            ...
                            if (resultFin == JOptionPane.OK_OPTION) {
                                ...
                                try {
                                    ...
                                    if (!existeCliente(idCliente)) {
                                        ...
                                        JOptionPane.showMessageDialog(null, "El cliente no existe. Por favor, seleccione un cliente v�lido.", "Error", JOptionPane.ERROR_MESSAGE);
                                    } else {
